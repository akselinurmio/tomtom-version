...
TomTom map version checker — a Cloudflare Worker that scrapes the TomTom help page daily, detects map version changes, stores history in Cloudflare KV, and sends email notifications via Resend when a new version is released.
...
### Scheduled job (daily at noon UTC)
